package com.devy.manager.config;

import com.devy.manager.RestServer.ProductsRestServerImpl;
import com.devy.manager.security.OAuthClientHttpRequestInterceptor;
